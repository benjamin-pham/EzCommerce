...
| Command Handler | Messaging, `Domain.Abstractions` (Result/IUnitOfWork), `Domain.Repositories` (entity repos) |
| Command Validator | `FluentValidation` |
| Query | `{ProjectName}.Application.Abstractions.Messaging` (or `.Caching`) |
| Query Handler | Messaging, `Domain.Abstractions` (Result), `Abstractions.Data`, `Dapper`, `System.Data` |
